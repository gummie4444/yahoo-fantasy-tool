...
// CurrentLeague
export const PICK_CURRENTLEAGUE_SUCCESFULL = 'PICK_CURRENTLEAGUE_SUCCESFULL';

export const CHANGE_DASHBOARD_MODE = 'CHANGE_DASHBOARD_MODE';

export const CHANGE_LEAGUE_ACTION = 'CHANGE_LEAGUE_ACTION';
export const GO_HOME = 'GO_HOME';

export const TEAM_INIT_DATA_FOR_LEAGUE_SUCCESFULL = 'TEAM_INIT_DATA_FOR_LEAGUE_SUCCESFULL';
export const TEAM_EXTRA_DATA_FOR_LEAGUE_SUCCESFULL = 'TEAM_EXTRA_DATA_FOR_LEAGUE_SUCCESFULL';

export const NEW_RANGE_TYPE = 'NEW_RANGE_TYPE';
export const FETCH_FANTASY_LEAGUE_SUCCESS = 'FETCH_FANTASY_LEAGUE_SUCCESS';
export const CHANGE_RANGE_TYPE_SUCCESS = 'CHANGE_RANGE_TYPE_SUCCESS';
